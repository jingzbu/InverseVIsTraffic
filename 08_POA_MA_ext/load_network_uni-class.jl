...
function load_ta_network(network_name="Sioux Falls")
    ...
    elseif network_name == "East_Massachusetts_Apr_PM"
        ...
        best_objective = 0
    elseif network_name == "East_Massachusetts_Apr_PM_ext"
	...
	best_objective = 0
    elseif network_name == "East_Massachusetts_Apr_weekend_ext"
        network_data_file = "East_Massachusetts_net_Apr_weekend_ext.txt"
        trip_table_file = "East_Massachusetts_trips_Apr_weekend_ext.txt"
	best_objective = 0
