...
# load od_nodes dict
od_nodesList_dict = zload('../temp_files/od_nodesList_dict_journal.pkz')
...
x = np.matrix.reshape(x, 258, 2520)
...
x_ = np.matrix.reshape(x_, 258, 30)
...
#     with open('../temp_files/OD_demand_matrix_Apr_weekday_PM_journal.txt', 'w') as the_file:
#         idx = 0
...
#     with open('../temp_files/OD_demand_matrix_Apr_weekday_PM_journal.json', 'w') as json_file:
