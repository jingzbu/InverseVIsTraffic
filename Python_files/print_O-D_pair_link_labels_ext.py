...
OD_pair_label_dict = {}
OD_pair_label_dict_ = {}
with open('../temp_files/O-D_pair_labels_ext.txt', 'w') as the_file:
    label = 0
...
link_label_dict = {}
link_label_dict_ = defaultdict(list)

link_list = ['1->2','2->1','1->3','3->1','2->3','3->2','2->4','4->2','3->6','6->3',
'4->6','6->4','4->7','7->4','4->7','7->4','4->5','5->4','6->7','7->6',
'5->8','8->5','5->9','9->5','7->9','9->7','7->11','11->7','9->10',
'10->9','8->10','10->8','10->11','11->10','8->12','12->8','10->13',
'13->10','11->14','14->11','12->13','13->12','12->13','13->12','12->13',
'13->12','13->14','14->13','13->14','14->13','12->15','15->12','13->15',
'15->13','13->16','16->13','14->16','16->14','14->16','16->14','15->17',
'17->15','16->17','17->16']
...
for i in range(m):
    link_label_dict_[link_list[i]].append(i)
