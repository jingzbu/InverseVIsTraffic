...
with open('../temp_files/numRoutes_Anaheim.json', 'r') as json_file:
...
with open('../temp_files/path-link_incidence_Anaheim.txt', 'r') as the_file:
    ...
    for row in the_file:
        if '->' in row:
            ...
            i = i + 1
    assert(i == r)
zdump(A, '../temp_files/path-link_incidence_matrix_Anaheim.pkz')
...
zdump(length_of_route_list, '../temp_files/length_of_route_list_Anaheim.pkz')

# length_of_route_list[139]

OD_pair_label_dict = zload('../temp_files/OD_pair_label_dict_Anaheim_network.pkz')
...
zdump(OD_pair_route_dict, '../temp_files/OD_pair_route_dict_Anaheim.pkz')

with open('../temp_files/OD_pair_route_dict_Anaheim.json', 'w') as json_file:
...
zdump(P, '../temp_files/OD_pair_route_incidence_Anaheim.pkz')
# zdump(P, '../temp_files/logit_route_choice_probability_matrix_Anaheim.pkz')
