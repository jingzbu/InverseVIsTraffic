...
zdump(tmc_day_capac_flow_dict, '../temp_files/tmc_day_capac_flow_dict_Jul_ext.pkz')
...
zdump(link_day_Jul_dict, '../temp_files/link_day_Jul_dict_ext.pkz')

# print(link_day_Jul_dict['link_22_29'].PM_flow)
