...
for link_idx in range(64):
    for day in week_day_Oct_list: 
        for minute_idx in range(120):
            ...
            link_day_minute_Oct_list.append(link_day_minute_Oct_dict_ext_JSON[key] ['AM_flow_minute'][minute_idx])
...
with open('../temp_files/OD_demand_matrix_Oct_weekday_AM_ext.txt', 'w') as the_file:
    idx = 0
