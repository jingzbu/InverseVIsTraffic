...
with open('../temp_files/link_day_minute_Oct_dict_journal_JSON.json', 'r') as json_file:
...
print(link_day_minute_Oct_dict_JSON['link_0_1'] ['AM_flow_minute'][0])
...
# Writing JSON data
with open('../temp_files/link_day_minute_Oct_dict_journal_JSON_adjusted.json', 'w') as json_file:
