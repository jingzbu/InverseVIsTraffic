...
link_label_dict = zload('../temp_files/link_label_dict_Sioux-Falls_network.pkz')
link_label_dict_ = zload('../temp_files/link_label_dict_Sioux-Falls_network_.pkz')

with open('../temp_files/link_length_dict_Sioux.json', 'r') as json_file:
...
with open('../temp_files/path-link_incidence_Sioux-Falls.txt', 'r') as the_file:
    ...
    for row in the_file:
        if '->' in row:
            ...
            i = i + 1
    assert(i == r)
zdump(A, '../temp_files/path-link_incidence_matrix_Sioux-Falls.pkz')
...
zdump(length_of_route_list, '../temp_files/length_of_route_list_Sioux-Falls.pkz')

# length_of_route_list[139]

OD_pair_label_dict = zload('../temp_files/OD_pair_label_dict_Sioux-Falls_network.pkz')
