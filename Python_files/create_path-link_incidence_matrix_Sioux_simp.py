...
with open('../temp_files/path-link_incidence_Sioux_simp.txt', 'r') as the_file:
    ...
    for row in the_file:
        if '->' in row:
            ...
            i = i + 1
    assert(i == r)
zdump(A, '../temp_files/path-link_incidence_matrix_Sioux_simp.pkz')
...
zdump(length_of_route_list, '../temp_files/length_of_route_list_Sioux_simp.pkz')

# length_of_route_list[139]

OD_pair_label_dict = zload('../temp_files/OD_pair_label_dict_Sioux_simp.pkz')
...
zdump(OD_pair_route_dict, '../temp_files/OD_pair_route_dict_Sioux_simp.pkz')
