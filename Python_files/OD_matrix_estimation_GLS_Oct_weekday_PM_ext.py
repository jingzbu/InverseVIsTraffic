...
for link_idx in range(74):
    for day in week_day_Oct_list: 
        for minute_idx in range(120):
            ...
            link_day_minute_Oct_list.append(link_day_minute_Oct_dict_ext_JSON[key] ['PM_flow_minute'][minute_idx])

# print(len(link_day_minute_Oct_list))

x = np.matrix(link_day_minute_Oct_list)
x = np.matrix.reshape(x, 74, 480)
...
with open('../temp_files/OD_demand_matrix_Oct_weekday_PM_ext.txt', 'w') as the_file:
    idx = 0
