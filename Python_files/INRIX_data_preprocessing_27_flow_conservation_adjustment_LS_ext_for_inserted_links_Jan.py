...
with open('../temp_files/link_day_minute_Jan_dict_ext_JSON_insert_links.json', 'r') as json_file:
...
# Writing JSON data
with open('../temp_files/link_day_minute_Jan_dict_ext_JSON_insert_links_adjusted.json', 'w') as json_file:
