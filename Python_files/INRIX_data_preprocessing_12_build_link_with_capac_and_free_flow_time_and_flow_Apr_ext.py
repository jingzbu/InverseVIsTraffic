...
zdump(tmc_day_capac_flow_dict, '../temp_files/tmc_day_capac_flow_dict_Apr_ext.pkz')
...
for day in range(31)[1:]:
    ...
    for link_with_capac in link_with_capac_list:
        ...
        link_day_Apr_dict['link_' + str(i) + '_' + str(day)] = link_with_capac_new
        i = i + 1

zdump(link_day_Apr_dict, '../temp_files/link_day_Apr_dict_ext.pkz')

# print(link_day_Apr_dict['link_22_29'].PM_flow)
