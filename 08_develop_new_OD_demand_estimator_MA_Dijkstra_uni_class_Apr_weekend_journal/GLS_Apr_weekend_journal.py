...
x = np.matrix.reshape(x, 258, 1080)
...
def saveDemandVec(lam_list):
    ...
    with open('../temp_files/OD_demand_matrix_Apr_weekend_journal.txt', 'w') as the_file:
        idx = 0
    ...
    with open('../temp_files/OD_demand_matrix_Apr_weekend_journal.json', 'w') as json_file:
