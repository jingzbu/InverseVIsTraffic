...
with open('./benchmark_data/journal_net_Apr_weekend.txt') as MA_journal_flow:
...
with open('./benchmark_data/journal_trips_Apr_weekend.txt') as MA_journal_trips:
...
link_length_list = []
with open('./benchmark_data/journal_net_Apr_weekend.txt', 'r') as f:
