...
week_day_Jan_list = [2, 3, 4, 5, 6, 9, 10, 11, 12, 13, 16, 17, 18, 19, 20, 23, 24]
...
x = np.matrix.reshape(x, 24, 120 * len(week_day_Jan_list))
...
def saveDemandVec(lam_list):
    ...
    with open('../temp_files/OD_demand_matrix_Jan_weekday_AM.json', 'w') as json_file:
