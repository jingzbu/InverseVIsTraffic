...
numNodes, numLinks, numODpairs, capacity, free_flow_time, ta_data_Apr_weekend = paraNetwork("MA_journal_Apr_weekend")
link_label_dict, link_label_dict_, link_length_dict = furInfo()

start_node = ta_data_Apr_weekend.start_node
end_node = ta_data_Apr_weekend.end_node
