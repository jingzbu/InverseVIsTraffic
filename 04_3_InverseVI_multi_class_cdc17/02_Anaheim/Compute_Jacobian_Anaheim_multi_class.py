...
with open('./data_Anaheim/Anaheim_flow.txt') as Anaheim_flow:
...
with open('./data_Anaheim/Anaheim_trips.txt') as Anaheim_trips:
...
link_length_list = []
with open('./data_Anaheim/Anaheim_net.txt', 'r') as f:
