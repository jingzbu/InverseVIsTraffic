...
with open('./data_Tiergarten/Tiergarten_net.txt') as Tiergarten_flow:
...
with open('./data_Tiergarten/Tiergarten_trips.txt') as Tiergarten_trips:
...
link_length_list = []
with open('./data_Tiergarten/Tiergarten_net.txt', 'r') as f:
