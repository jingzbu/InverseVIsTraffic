...
function furInfo()
    ...
    numRoutes = readall("../temp_files/numRoutes_Sioux_simp.json")
    numRoutes = JSON.parse(numRoutes)

    #load OD pair-route incidence
    odPairRoute = readall("../temp_files/od_pair_route_incidence_Sioux_simp.json")
    odPairRoute = JSON.parse(odPairRoute)

    #load link-route incidence
    linkRoute = readall("../temp_files/link_route_incidence_Sioux_simp.json")
    linkRoute = JSON.parse(linkRoute)

    link_label_dict = readall("../temp_files/link_label_dict_Sioux_simp.json")
